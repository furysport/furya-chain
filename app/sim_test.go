...
func TestAppImportExport(t *testing.T) {
	...
	app := NewFuryaApp(logger, db, nil, true, map[int64]bool{}, dir, simcli.FlagPeriodValue, encConf, EmptyBaseAppOptions{}, nil, fauxMerkleModeOpt)
	...
	newApp := NewFuryaApp(logger, newDB, nil, true, map[int64]bool{}, newDir, simcli.FlagPeriodValue, encConf, EmptyBaseAppOptions{}, nil, fauxMerkleModeOpt)
...
func TestFullAppSimulation(t *testing.T) {
	...
	encConf := MakeEncodingConfig()
	app := NewFuryaApp(logger, db, nil, true, map[int64]bool{}, t.TempDir(), simcli.FlagPeriodValue,
		encConf, simtestutil.EmptyAppOptions{}, nil, fauxMerkleModeOpt)
	require.Equal(t, "FuryaApp", app.Name())
