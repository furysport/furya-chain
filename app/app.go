...
import (
	...
	feeburnmodule "github.com/furysport/furya-chain/v2/x/feeburn"
	feeburnmoduleclient "github.com/furysport/furya-chain/v2/x/feeburn/client"
	feeburnmodulekeeper "github.com/furysport/furya-chain/v2/x/feeburn/keeper"
	feeburnmoduletypes "github.com/furysport/furya-chain/v2/x/feeburn/types"
	...
	appparams "github.com/furysport/furya-chain/v2/app/params"
...
// FuryaApp extended ABCI application
...
// NewFuryaApp returns a reference to an initialized FuryaApp.
func NewFuryaApp(
	logger log.Logger,
	db dbm.DB,
	...
	wasmHooks := ibchooks.NewWasmHooks(&hooksKeeper, nil, furyaPrefix) // The contract keeper needs to be set later
...
func (app *FuryaApp) ModuleConfigurator() module.Configurator {
...
func (app *FuryaApp) DefaultGenesis() map[string]json.RawMessage {
...
func RegisterSwaggerAPI(rtr *mux.Router) {
	...
	statikFS, err := fs.NewWithNamespace("furya")
	if err != nil {
		panic(err)
	}
